...
crossScalaVersions in ThisBuild := Seq("2.13.7", "2.12.15", "2.11.12")
...
lazy val sqlDeltaImport = (project in file("sql-delta-import"))
  .settings (
    ...
    libraryDependencies ++= Seq(
      ...
      "io.delta" % "delta-core_2.13" % "1.1.0" % "provided",
      "org.rogach" %% "scallop" % "3.5.1",
      "org.scalatest" %% "scalatest" % scalaTestVersion % "test",
      "com.h2database" % "h2" % "1.4.200" % "test",
      "org.apache.spark" % "spark-catalyst_2.13" % "3.2.0" % "test",
      "org.apache.spark" % "spark-core_2.13" % "3.2.0" % "test",
      "org.apache.spark" % "spark-sql_2.13" % "3.2.0" % "test"
    )
  )
