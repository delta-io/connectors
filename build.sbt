...
//  scalacOptions ++= Seq("-target:jvm-1.8", scalacWarningUnusedImport(scalaVersion.value), "-deprecation"),
lazy val commonSettings = Seq(
  ...
  scalacOptions ++= Seq(scalacWarningUnusedImport(scalaVersion.value)),
