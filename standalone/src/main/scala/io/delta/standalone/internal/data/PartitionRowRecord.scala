...
private[internal] class PartitionRowRecord(
  ...
  override def getString(fieldName: String): String = "" // TODO

  override def getBinary(fieldName: String): Array[Byte] = Array.empty // TODO
  ...
  override def getList[T](fieldName: String): java.util.List[T] = null // TODO unsupported op?

  override def getMap[K, V](fieldName: String): java.util.Map[K, V] = null // TODO unsupported op?
}
